    ...
    def OutData(self):
        ...
        while True: 
            ...
            try:
                ...
                # if outcount <= self.fruitslist.loc[[np.where(self.fruitslist['fruitname'] == outfruitname)[0]],['count']]:
            ...
            for i in self.fruitslist.index:
                while self.fruitslist['fruitname'][i] == outfruitname:
                    ...
                    # if pd.to_numeric(self.fruitslist.loc[self.fruitslist['fruitname']==outfruitname, 'count'])==0:
